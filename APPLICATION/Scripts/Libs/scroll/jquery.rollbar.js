define([/*"jquery", */"Libs/scroll/jquery.easing.1.3", "Libs/scroll/jquery.mousewheel"], function (/*$*/) {
    ...
    function RollBar(c, s) {
        ...
        this.vslider.css({ 'height': '100%', 'opacity': this.settings.sliderOpacity });
        this.hslider.css({ 'width': '100%', 'opacity': this.settings.sliderOpacity });
